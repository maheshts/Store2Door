...
public class ReportTranListAdapter extends RecyclerView.Adapter<ReportTranListAdapter.ItemViewHolder> {


    private List<DatumOrderRequest> responseDatumOrderRequestList;
    ...
    public ReportTranListAdapter(List<DatumOrderRequest> mResponseDatumOrderRequestList, Context context, OnClickListener onClickListener
            , boolean isDashBoard) {

        this.responseDatumOrderRequestList = mResponseDatumOrderRequestList;
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, final int position) {
        ...
        DatumOrderRequest datum = responseDatumOrderRequestList.get(position);
    ...
    public int getItemCount() {
        return responseDatumOrderRequestList.size();
    }
