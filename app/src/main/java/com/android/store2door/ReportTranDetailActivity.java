...
import com.android.store2door.adapter.ReportStockListAdapter;
...
public class ReportTranDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (datum != null) {
            ...
            if (datum.getStockItems() != null && datum.getStockItems().size() != 0)
                rvProductListDetail.setAdapter(new ReportStockListAdapter(datum.getStockItems(), mContext));
